...
let alienEspecifico = aliens.find(function (alienigenas){
    return alienigenas.name === "Cucushumushu"
})

let mutationEspecifica = mutations.find(function (mutaciones){
    return mutaciones.name === "Porompompero"
})

alienEspecifico.mutaciones = mutationEspecifica

console.log(alienEspecifico)