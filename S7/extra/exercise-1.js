...
// ```
let videogameGenders = []

for(juegos in videogames){
    videogameGenders.push(videogames[juegos].genders)
}

const encontrarJuegos = videogameGenders.find(function (encontrados){
    return encontrados === "RPG"
})

console.log(encontrarJuegos)